  ...
  <div className="fixed flex items-center">
    <section className="h-screen bg-navBg w-32 bg-no-repeat text-navFont flex-col items-center">
      <div className="my-10 ml-12">
        <Image className="" src={IcMenuInfo} alt="" width={60} />
        關卡資訊
      </div>
      <div className="mt-10 ml-12">
        <Image className="" src={IcMenuList} alt="" width={60} />
        作品列表
      </div>
      <div className="mt-10 ml-12">
        <Image className="" src={IcMenuStrategy} alt="" width={60} />
        攻略資源
      </div>
      <div className="mt-10 ml-12">
        <Image className="" src={IcMenuJob} alt="" width={60} />
        求職專區
      </div>
      <div className="bg-nav-close-btn w-16 inline-block" />
    </section>
    <div className="w-5 h-screen bg-nav-bg bg-cover bg-right" />
    <div className="w-16 h-16 bg-nav-close-btn bg-cover -ml-px" />
  </div>
);
