...
export default () => {
  const section1Ref = useRef() as React.MutableRefObject<HTMLInputElement>;
  gsap.registerPlugin(ScrollTrigger);
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      const step1Effect = gsap.timeline({
        scrollTrigger: {
          trigger: '.section1',
          start: 'top 0%',
          end: '+=1200',
      ...
      step1Effect
        ...
        .to('.section1-fixed-item', { opacity: 0 })
  ...
  return (
    <section ref={section1Ref} className="section1 w-full h-2vh bg-secondary">
      <div className="section1-fixed-item fixed w-full h-full">
